            ...
            <div className="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                <div className="flex h-16 shrink-0 items-center">
                  <img
                    className="h-13 w-auto max-w-[110px] object-contain"
                    src="/logo.png"
                    alt="EduBuild"
                  />
                  <span className="ml-2 text-xl font-extrabold tracking-wide text-indigo-600">
                    Edu<span className="text-orange-500">Build</span>
                  </span>
                </div>
